            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 lg:py-8 px-4 mx-auto max-w-screen-md">
                    ...
                    <form id="contacto_form" action="{{ route('contacto.form.store') }}" method="POST" class="space-y-8">
                            ...
                            <div class="md:pl-5 flex flex-col space-y-2 text-base md:text-lg">
                                <div>
                                    <input type="radio" id="cotizaciones"
                                           name="mensaje_asunto" value="Cotizaciones de nuestros servicios"
                                           @checked($asunto == 1)
                                ...
                                <div>
                                    <input type="radio" id="info"
                                           name="mensaje_asunto" value="Información o dudas sobre nuestros servicios"
                                           @checked($asunto == 2)
                                           class="w-5 h-5 text-vxproject-secondary border-vxproject-secondary focus:ring-vxproject-primary rounded-full">
                                ...
                                <div>
                                    <input type="radio" id="vxproject_field"
                                           name="mensaje_asunto" value="Suscripción a VX Project - Field"
                                           @checked($asunto == 3)
                                           class="w-5 h-5 text-vxproject-secondary border-vxproject-secondary focus:ring-vxproject-primary rounded-full">
                                ...
                                <div>
                                    <input type="radio" id="dudas"
                                           name="mensaje_asunto" value="Dudas sobre nuestros artículos"
                                           @checked($asunto == 4)
                                           class="w-5 h-5 text-vxproject-secondary border-vxproject-secondary focus:ring-vxproject-primary rounded-full">
                                ...
                                <div>
                                    <input type="radio" id="comentarios"
                                           name="mensaje_asunto" value="Sugerencias y comentarios"
                                           @checked($asunto == 5)
                                           class="w-5 h-5 text-vxproject-secondary border-vxproject-secondary focus:ring-vxproject-primary rounded-full">
                        ...
                        <div>
                            <label for="nombre" class="block mb-2 text-base font-medium text-gray-900 dark:text-gray-300">Tu nombre</label>
                            <input type="text"
                                   id="nombre"
                                   name="nombre"
                                   autofocus
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-vxproject-secondary focus:border-vxproject-secondary block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-vxproject-secondary dark:focus:border-vxproject-secondary dark:shadow-sm-light"
                                   placeholder="nombre@email.com" required>
                        </div>
                        <div class="sm:col-span-2">
                            <label for="mensaje" class="block mb-2 text-base font-medium text-gray-900 dark:text-gray-400">Tu mensaje</label>
